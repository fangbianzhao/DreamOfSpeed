...
public class TPSGameManager : MonoBehaviour {
    ...
    void CreateTrap(TrapEntity trapEntity)
    {
        ...
        TrapController TrapController = newTrap.GetComponent<TrapController>();

        TrapController.trapID = trapEntity.entityID;
        TrapController.trapType = trapEntity.trapType;
        TrapController.playerID = trapEntity.playerID;
