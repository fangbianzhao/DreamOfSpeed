...
public class GameManager : MonoBehaviour {
    ...
    {
        NextLevelTimeController.nextLevelTime = serverNextLevelTimeMsg.nextLevelTime;
    }
    ...
    void ThrowPumpkin(Vector3 beginPoint, Vector3 endPoint, int monsterID)
    {
        ...
        pumpkin.GetComponent<BombController>().monsterID = monsterID;
    ...
    void CreateTrap(TrapEntity trapEntity)
    {
        ...
        TrapController trapControl = newTrap.GetComponent<TrapController>();
    ...
    GameObject FindMissileWithID(int entityID)
    {
        ...
        {
            MissileController missileControl = missiles[i].GetComponent<MissileController>();
    ...
    void MissileExplosion(ServerMissileExplosionMsg serverMissileExplosionMsg)
    {
        ...
        if (missile != null)
        {
            MissileController missileControl = missile.GetComponent<MissileController>();
            if (missileControl != null && missileControl.missileID == entityID)
            {
    ...
    void CreateMissile(MissileEntity missileEntity)
    {
        ...
        if (missileEntity.playerID == GameSettings.playerID)
        {
            ...
            MissileController missileControl = newMissile.GetComponent<MissileController>();
